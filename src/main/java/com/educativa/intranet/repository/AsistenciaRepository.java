...
public interface AsistenciaRepository extends JpaRepository<Asistencia, Long> {
    ...
    @Query("SELECT a FROM Asistencia a WHERE (a.alumno.usuario.id = :usuarioId OR a.alumno.padre.usuario.id = :usuarioId) AND YEAR(a.fecha) = :anio AND MONTH(a.fecha) = :mes ORDER BY a.fecha ASC")
